<%@ Page Language="VB" AutoEventWireup="true" CodeBehind="Default.aspx.vb" CodeFile="Default.aspx.vb" Inherits="lite_offline_Default" %>
...
<head id="Head1" runat="server">
    ...
    {
        navigator.serviceWorker.register("offline-service-worker.js?ver=<%=PdfWebControlLite.Version%>").then(function(reg)
        {
            var sw;
...
<body>
    ...
    <div>
        <radPdf:PdfWebControlLite id="PdfWebControl1" runat="server" height="600px" width="100%" RenderAtClient="true" OnClientLoad="onRadPdfLoad(this);" />
    </div>
    </form>
</body>
</html>